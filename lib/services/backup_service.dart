...
class BackupService {
  ...
  static Future<void> shareBackup() async {
    try {
      ...
      await Share.shareXFiles(
        [XFile(filePath)],
        text: 'Sentinel Backup - ${DateTime.now().toString().split(' ')[0]}',
        subject: 'Sentinel Data Backup',
      );
    } catch (e) {
  ...
  static String _generateAcademicReport(Map<String, dynamic> backup) {
    ...
    buffer.writeln('╔══════════════════════════════════════════════════════════╗');
    buffer.writeln('║                 SENTINEL ACADEMIC REPORT                 ║');
    buffer.writeln('╚══════════════════════════════════════════════════════════╝');
    ...
    // Footer
    buffer.writeln('═══════════════════════════════════════════════════════════');
    buffer.writeln('Report generated by Sentinel - The Ultimate Student OS');
    buffer.writeln('For support, contact: support@sentinel.app');
    buffer.writeln('═══════════════════════════════════════════════════════════');
