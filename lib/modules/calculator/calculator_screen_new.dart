...
class _BMITab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text('BMI Calculator', style: TextStyle(color: Colors.white)));
  }
}

class _AgeCalculatorTab extends StatelessWidget {
  const _AgeCalculatorTab();
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text('Age Calculator', style: TextStyle(color: Colors.white)));
  }
}
...
class _PercentageTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Center(child: Text('Percentage Calculator', style: TextStyle(color: Colors.white)));
  }
}
