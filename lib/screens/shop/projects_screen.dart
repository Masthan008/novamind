    ...
    if (await canLaunchUrl(uri)) {
      ...
      try {
        await Supabase.instance.client
            .from('projects')
            .update({'downloads': (await Supabase.instance.client
                .from('projects')
                .select('downloads')
                .eq('id', projectId)
                .single())['downloads'] + 1})
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        leading: Container(
                          ...
                          child: Icon(
                            _getCategoryIcon(project['category'] ?? 'All'),
                        ...
                        trailing: isLocked
                            ...
                            : IconButton(
                                ...
                                onPressed: project['zip_link'] != null 
                                    ? () => _downloadProject(project['zip_link'], project['id'])
                                    : null,
                              ),
                      ),
